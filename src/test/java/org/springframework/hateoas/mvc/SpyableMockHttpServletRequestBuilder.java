 ...
 * requests in {@link MockMvc} that allow spying with Mockito.spy().
 *
 *
 ...
 * @since 3.2
 */
public class SpyableMockHttpServletRequestBuilder
		implements ConfigurableSmartRequestBuilder<SpyableMockHttpServletRequestBuilder>, Mergeable {
	 ...
	 */
	SpyableMockHttpServletRequestBuilder(boolean mock, HttpMethod httpMethod, String urlTemplate, Object... urlVariables) {
	 ...
	 * @since 4.0.3
	 */
	SpyableMockHttpServletRequestBuilder(boolean mock, HttpMethod httpMethod, URI uri) {
		Assert.notNull(httpMethod, "httpMethod is required");
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder param(String name, String... values) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder header(String name, Object... values) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder headers(HttpHeaders httpHeaders) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder contentType(MediaType contentType) {
	 ...
	 * @since 4.1.2
	 */
	public SpyableMockHttpServletRequestBuilder contentType(String contentType) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder accept(MediaType... mediaTypes) {
	 ...
	 * @param mediaTypes one or more media types
	 */
	public SpyableMockHttpServletRequestBuilder accept(String... mediaTypes) {
		Assert.notEmpty(mediaTypes, "No 'Accept' media types");
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder content(byte[] content) {
	 ...
	 * @param content the body content
	 */
	public SpyableMockHttpServletRequestBuilder content(String content) {
		try {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder cookie(Cookie... cookies) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder locale(Locale locale) {
		this.locale = locale;
		return this;
	}
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder characterEncoding(String encoding) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder requestAttr(String name, Object value) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder sessionAttr(String name, Object value) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder sessionAttrs(Map<String, Object> sessionAttributes) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder flashAttr(String name, Object value) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder flashAttrs(Map<String, Object> flashAttributes) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder session(MockHttpSession session) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder principal(Principal principal) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder contextPath(String contextPath) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder servletPath(String servletPath) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder pathInfo(String pathInfo) {
	 ...
	 */
	public SpyableMockHttpServletRequestBuilder secure(boolean secure){
		this.secure = secure;
		return this;
	}
	 ...
	 */
	@Override
	public SpyableMockHttpServletRequestBuilder with(RequestPostProcessor postProcessor) {
	...
	public Object merge(Object parent) {
		...
		if (!(parent instanceof SpyableMockHttpServletRequestBuilder)) {
			throw new IllegalArgumentException("Cannot merge with [" + parent.getClass().getName() + "]");
		}
		SpyableMockHttpServletRequestBuilder parentBuilder = (SpyableMockHttpServletRequestBuilder) parent;
